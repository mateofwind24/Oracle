...
.b-sum{font-size:14px;color:var(--mok);font-weight:400;margin-bottom:12px;padding-left:14px;border-left:3px solid var(--mok)}.part.saju .b-sum{color:var(--hwa);border-color:var(--hwa)}.b-body{font-size:15.5px;line-height:1.78;color:var(--ink);max-width:64ch}
