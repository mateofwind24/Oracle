...
_DEFAULT_FACE_BLOCKS = (
    {
        ...
        "title": "균형감이 살아 있는 기본 상",
        "summary": "얼굴의 세로·가로 비율과 좌우 균형을 함께 봤을 때 기본 결이 차분하게 읽히는 상입니다.",
    ...
    {
        "category": "강점으로 읽히는 복과 기세",
        "title": "눈과 눈썹에서 드러나는 기세",
        "summary": "눈은 시선의 또렷함, 눈썹은 인상을 정돈하는 선으로 해석하며 강점의 결을 읽습니다.",
        "body": "눈 주변이 또렷하게 보이면 생각을 빠르게 모으고 반응을 분명하게 드러내는 분위기로 풀이합니다. 눈썹이 눈을 안정적으로 감싸면 감정을 급하게 드러내기보다 정돈해서 표현하는 인상으로 설명할 수 있습니다.",
    },
    {
        "category": "관계와 대인운",
        "title": "표정과 중심감이 만드는 대인 흐름",
        "summary": "코와 입매, 얼굴 좌우 균형은 사람을 대할 때의 안정감과 거리감을 읽는 기준이 됩니다.",
        "body": "코가 얼굴 중심에서 안정적으로 보이면 기준을 세우고 현실적으로 판단하려는 인상으로 읽습니다. 입 주변과 좌우 균형이 자연스럽게 정돈되어 보이면 대인관계에서는 차분하게 분위기를 맞추는 쪽으로 설명할 수 있습니다.",
    },
    {
        "category": "앞으로 살릴 운의 방향",
        "title": "강한 인상을 어떻게 살릴지",
        "summary": "지금 보이는 균형감은 신뢰와 중심감이 필요한 자리에서 특히 잘 살아나는 흐름입니다.",
        "body": "표정이 안정적으로 보이면 상대가 느끼는 긴장감을 낮추고 편안하게 대화를 시작하는 인상으로 해석합니다. 이런 결은 말을 서두르기보다 중심을 지키며 설득하거나 조율하는 자리에서 더 좋은 흐름으로 이어질 수 있습니다.",
    },
    {
        "category": "조심할 점과 생활 조언",
        "title": "삼정 균형을 지키는 생활 리듬",
        "summary": "삼정은 얼굴을 위·가운데·아래 세 구역으로 나누어 균형을 보는 전통 기준이며, 조급함을 줄일 때 장점이 더 잘 살아납니다.",
        "body": "삼정은 얼굴을 위·가운데·아래 세 구역으로 나누어 균형을 보는 전통 기준입니다. 이마는 계획과 생각의 폭, 중안부는 현실감과 실행력, 하관은 마무리와 지속성을 상징하는 식으로 풀이합니다. 세 구역이 고르게 보이면 특정 시기보다 전체 흐름을 균형 있게 가져가는 인상으로 설명하며, 생활에서는 급하게 결론을 내리기보다 호흡을 한 번 고르는 습관이 장점을 더 안정적으로 살려 줍니다.",
    },
)
...
.ohaeng h3,.myeongsik .cap,.tags h3{font-family:"Gowun Batang",serif;font-size:18px;letter-spacing:.3em;color:var(--ink-soft);text-align:center;margin-bottom:26px;font-weight:400}
...
.pcol .ptitle{font-size:16px;font-weight:700;color:var(--ink-soft);margin-bottom:6px}
.cell{border-radius:5px;padding:12px 4px;color:#fff}.cell .ch{font-family:"Song Myung",serif;font-size:34px;line-height:1.1}.cell .ss{font-size:15px;opacity:.92;margin-top:3px}.cell.gan{margin-bottom:6px}
...
.block{margin-bottom:34px}.b-cat{font-size:15px;letter-spacing:.25em;color:var(--gold);text-transform:uppercase;margin-bottom:8px}.b-title{font-family:"Gowun Batang",serif;font-size:21px;font-weight:700;line-height:1.4;margin-bottom:10px}
