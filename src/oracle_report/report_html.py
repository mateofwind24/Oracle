...
_DEFAULT_SAJU_BLOCKS = (
    {
        "category": "종합 형국 및 원국 해설",
        "title": "사주 데이터가 보여주는 거대한 삶의 형국",
        "summary": "일간과 오행 분포를 중심으로 한 대자연의 흐름을 해설합니다.",
        "body": "만세력 DB에서 조회한 명식 구조를 바탕으로, 인생 전반을 관통하는 타고난 고유의 에너지와 환경적 역동성을 종합적으로 해부합니다.",
    },
    {
        "category": "오행 분포와 기운 개운법",
        "title": "내 사주의 결핍을 채워줄 시원한 기운 처방전",
        "summary": "과다하거나 고립된 오행을 진단하여 일상적 개운책을 제안합니다.",
        "body": "특정 오행의 편중이나 증발 상태를 날카롭게 짚어내고, 부족한 에너지를 보강하여 삶의 밸런스를 즉시 끌어올릴 수 있는 데일리 컬러, 액세서리, 공간 배치법을 가이드합니다.",
    },
    {
        "category": "신살 및 십성 심리 해부",
        "title": "가면 뒤에 숨겨진 무의식적 완벽주의와 강박",
        "summary": "사주에 배치된 강력한 신살과 십성의 본질적 마찰을 추적합니다.",
        "body": "원국에 자리 잡은 강렬한 살성과 통제 기운이 외부로 발산되지 못해 자신을 공격하는 무의식적 심리 메커니즘과 방어기제를 정신분석학적으로 예리하게 해부합니다.",
    },
    {
        "category": "성격 분석 및 후천적 변화",
        "title": "반전의 양면성과 나이가 들수록 변해갈 성격 지도",
        "summary": "사회적 페르소나와 내면에 소용돌이치는 진짜 욕망의 격차를 읽습니다.",
        "body": "겉으로 보여지는 묵직하고 반듯한 모습 속에 감추어진 뜨거운 열정과 승부욕을 분석하고, 후천적으로 대운의 변화에 따라 확장될 성격의 변동 지도를 그립니다.",
    },
    {
        "category": "직업 적성과 사회적 무기",
        "title": "조직의 한계를 부수고 전문적 권한을 쥘 독보적 칼날",
        "summary": "상명하복식 구조를 탈피하여 스스로 주체가 되는 무기를 탐색합니다.",
        "body": "단순 지시 이행에 갇히는 보수적인 환경의 한계를 짚어내고, 기발한 기술력이나 분석력을 바탕으로 독립적인 권한을 행사할 수 있는 전문 분야 및 크리에이티브 방향성을 제시합니다.",
    },
    {
        "category": "재물운과 자산 설계",
        "title": "돈의 흐름을 가두고 자산을 거대하게 가두는 축재 비법",
        "summary": "타고난 재물 기질과 미래에 자산이 안정화될 계기를 콕 집어냅니다.",
        "body": "유년기 시절의 부채감이나 책임감을 따뜻하게 달래준 뒤, 투기성 흐름을 경계하고 견고한 안전 자산에 재물을 봉인하여 자산 규모를 극대화할 수 있는 영리한 재테크 기법을 처방합니다.",
    },
    {
        "category": "연애운과 이상형 인연",
        "title": "내 무거운 짐을 함께 나누어 짊어질 구원의 귀인 서사",
        "summary": "연애에서 발동하는 강박을 해소해 줄 최적의 인연을 매핑합니다.",
        "body": "사랑할 때조차 해결사를 자처하며 상대를 통제하려는 영웅주의적 강박의 가면을 벗겨내고, 메마른 영혼에 생기를 불어넣어 줄 오행 기운을 가진 상대방과의 만남 시나리오를 점칩니다.",
    },
    {
        "category": "부모 및 가족 관계",
        "title": "가족이라는 무거운 숙제를 벗어나 온전한 독립군이 될 운명",
        "summary": "내 어깨를 짓누르는 희생의 악순환과 한계 설정법을 다룹니다.",
        "body": "사주 원국에서 부모나 형제의 존재가 버팀목을 넘어 무거운 짐으로 다가왔던 내막을 예리하게 분석하고, 명리학적 액땜의 유일한 해법인 물리적·정신적 독립 타이밍을 전수합니다.",
    },
    {
        "category": "대인관계와 인맥 다이어트",
        "title": "가짜 인맥의 소음을 쳐내고 진짜 아군만 남기는 단호함",
        "summary": "해결사를 자처하는 고독한 무의식과 기회주의적 얽힘을 정리합니다.",
        "body": "넓고 얕은 인간관계에서 오는 에너지 낭비를 칼같이 통제하게 하고, 내 아픔과 고독을 있는 그대로 받아들여 줄 진짜 인덕과 귀인만을 남기는 족집게 인간관계 다이어트 룰을 처방합니다.",
    },
    {
        "category": "공간 및 지리적 개운 처방",
        "title": "시원한 물길과 서늘한 풍수 방향을 따라 영토를 확장할 기적",
        "summary": "꽉 막히거나 조열한 사주를 뚫어줄 국내외 최고의 길지를 지정합니다.",
        "body": "원국의 흉운을 대박 성공의 기회로 반전시킬 수 있도록, 물줄기가 풍부한 해안 도시나 호수 인접 지역, 혹은 내 기운에 딱 맞는 방향으로의 지리적 이동 및 공간 풍수 비법을 처방합니다.",
    },
    {
        "category": "올해의 운세 및 총평",
        "title": "2026년 병오년의 불꽃 끝에 피어날 찬란한 봄날의 축복",
        "summary": "병오년의 강렬한 기운이 원국과 만나 충돌할 현실적 대박 사건을 예고합니다.",
        "body": "올해 하반기 내에 터질 파격적인 환경적 격변과 기회의 타이밍을 사건 중심으로 리딩하며, 정해진 숙명에 무너지지 않고 삶을 개척해 나갈 영혼의 따뜻한 위로와 족집게 행동 지침으로 마무리합니다.",
    },
)
...
def _default_saju_blocks(reading) -> tuple[Mapping[str, str], ...]:
    print("[Report] Using extended 11-category default fallback blocks for saju_blocks")
    chart = reading.chart
    ...
    defaults = (
        {
            **_DEFAULT_SAJU_BLOCKS[0],
            "summary": f"{pillar_text} 명식을 바탕으로 인생 전체 기운의 근본적인 형국을 살핍니다.",
            "body": f"{summary} 내 삶을 지탱하는 본질적인 구조는 {interpretation} 기운의 흐름과 깊은 연관이 있습니다. 사방을 둘러싼 오행의 배치는 정해진 감옥이 아니라, 내가 다루어야 할 무기이자 인생의 계절적 무대를 암시하는 내비게이션 지도와 같습니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[1],
            "summary": f"내 사주의 오행 균형 분석 결과는 {counts_text} 상태입니다.",
            "body": f"만세력 분석 결과 내 원국에서 가장 왕성하게 폭주하는 에너지는 {strongest} 기운이며, 상대적으로 바짝 말라 있거나 고립되어 보완이 시급한 핵심 에너지는 {weakest} 기운으로 진단됩니다. 일상 속에서 {strongest} 기운을 무리하게 과용하기보다, {weakest} 기운을 보완하는 휴식 방식이나 일상 오브제 처방을 통해 기신의 흐름을 시원하게 개운해야 합니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[2],
            "summary": f"타고난 강력한 살성과 십성의 정렬이 내면 심리에 미치는 강박적 마찰을 해부합니다.",
            "body": f"내 안의 뼈대를 이루는 {strongest}의 십성 기운과 특수 살성이 결합할 때, 남들에게 절대 들키고 싶지 않은 자존심 과잉이나 완벽주의적 자기검열의 방어기제가 무의식중에 작동하게 됩니다. 이 거대하고 반듯한 억압의 틀은 스스로를 고독한 늑대처럼 몰아세우는 원인이 되므로, 내면의 칼날을 나 자신에게로 겨누지 않도록 심리학적인 환기가 필요합니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[3],
            "summary": f"겉으로 보여지는 묵직한 가면과, 홀로 있을 때 꿈꾸는 후천적 성격의 지형도입니다.",
            "body": f"일간인 {day_master}의 성정은 사회적으로 대단히 신뢰감 있고 흔들림 없는 페르소나를 구축하게 만들지만, 마음 심연 속에는 언제든 판을 뒤엎고 주도권을 쥐고 싶어 하는 뜨거운 야망이 숨어 있습니다. 시간이 흐르고 후천적인 대운의 변곡점을 지날수록 당신은 더욱 주체적이고 타인의 간섭을 완전히 거부하는 강인한 독립군 형태로 진화해 나갈 운명입니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[4],
            "summary": f"강압적이고 보수적인 상명하복의 울타리가 왜 당신에게 지옥이 되는지 증명합니다.",
            "body": f"당신의 사주는 지시를 맹목적으로 따르는 수동적인 조직 환경에서 극심한 정신적 소모를 겪는 구조입니다. 내 손으로 결정권을 완전히 장악하거나, 독보적인 기술 및 정밀한 분석력을 발휘해 집단 내에서 파격적인 독립적 권한을 쥐는 전문직 혹은 크리에이터 영역으로 나아갈 때 비로소 사회적 자산 가치가 폭발하게 됩니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[5],
            "summary": f"어깨를 누르던 경제적 부채감을 털어내고 자산의 댐을 구축하는 축재 마인드를 설계합니다.",
            "body": f"인생 초년에 마주했을 무거운 현실적 책임감과 압박을 딛고 일어나, 스스로 자수성가하여 일구어낼 재물의 잠재적 스케일은 결코 작지 않습니다. 다만, 변동성이 심한 투기성 환경에 돈을 노출하면 탈재의 흉운이 따르기 쉬우므로, 반드시 {weakest} 기운을 보완해 줄 수 있는 견고하고 단단한 부동산이나 안전 자산의 형태로 재물의 숨통을 묶어두는 족집게 설계가 필수적입니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[6],
            "summary": f"연애할 때조차 상대방을 온전히 책임져야 한다는 영웅주의 강박의 실체를 밝혀냅니다.",
            "body": f"관계를 맺을 때 나도 모르게 발동하는 과도한 통제 욕구나 보호 본능은 내면의 외로움과 상처를 감추기 위한 가면일 수 있습니다. 당신의 굳어버린 긴장감을 완벽하게 해제하고 영혼을 촉촉하게 적셔줄 최적의 오행 파트너는 {weakest} 기운을 풍부하게 품은 사람이며, 앞으로 예상치 못한 경로와 낯선 장소에서 격정적인 인연의 서사가 시작되는 사건이 반드시 도래합니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[7],
            "summary": f"가족이라는 이름의 무거운 희생양이 되기를 거부하고 주체적으로 자립할 타이밍입니다.",
            "body": f"사주 원국 상 부모와 형제의 숙제는 내 인생의 든든한 그늘막이 되어주기보다, 내 어깨를 무겁게 짓누르며 헌신만을 요구하는 굴레로 작용하기 쉽습니다. 명리학적으로 이 카르마를 끊어내고 가문을 살릴 유일한 방법은 물리적·정신적인 완벽한 거리두기를 선포하는 것이며, 단호한 선 긋기를 행할 때 비로소 가족 관계의 진정한 상생이 시작됩니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[8],
            "summary": f"사람은 많으나 진심을 나눌 동료가 없어 발생하는 인맥의 소음을 정리합니다.",
            "body": f"주변의 부탁을 거절하지 못하고 만인의 해결사 노릇을 자처하다 정작 본인의 에너지가 방전되는 감정의 노폐물 노출 상태입니다. 넓고 얕은 인간관계에서 오는 기회주의적인 인맥의 얽힘을 과감히 다이어트하고, 내 침묵과 아픔을 온전히 포용해 줄 수 있는 극소수의 찐 아군에게만 집중하는 단호함이 필요한 때입니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[9],
            "summary": f"메마르고 꽉 막힌 사주의 숨통을 시원하게 터줄 지리적 길지와 이동 처방전입니다.",
            "body": f"현재 명식의 극단적인 조열함을 해결하기 위해서는 뜨겁고 건조한 남쪽 방향이나 중동 같은 환경은 절대 피해야 합니다. 대신 서늘하고 수 기운이 풍부한 대형 한강 이북 지역, 해안 도시, 혹은 해외의 시원한 국가로 물을 건너 이동하는 행위 자체가 막혔던 대운의 물꼬를 터트려 명예와 직위를 급격히 격상시키는 완벽한 풍수 개운책이 됩니다.",
        },
        {
            **_DEFAULT_SAJU_BLOCKS[10],
            "summary": f"2026년 [병오년]의 강력한 화(火) 기운이 몰고 올 심리적 충동과 하반기 대박 사건을 예고합니다.",
            "body": f"올해 병오년의 불꽃 같은 에너지는 내 사주 원국의 {strongest} 기운과 격렬하게 충돌하며 삶의 판도를 통째로 바꾸고 싶다는 강한 충동을 자극하게 됩니다. 이 파동은 단순한 방황이 아니라 오래 묵은 억압을 뚫고 나오는 혁신의 기회이며, 올해 하반기 내에 귀인의 결정적인 조력이나 파격적인 계약 성사를 통해 찬란한 결실로 귀결되는 운명의 신호탄이 될 것입니다.",
        },
    )
...
@media (max-width:760px){.saju-wrap{padding:18px 14px 28px}.saju-page-nav{top:16px;left:14px;right:14px}.saju-round{width:42px;height:42px;font-size:30px}.saju-round:last-child{font-size:28px}.saju-hero{padding:34px 0 22px}.saju-brand{gap:12px;font-size:32px}.saju-brand span{font-size:20px}.saju-cloud,.saju-spark,.saju-floating-heart,.compat-heart-float{display:none}.saju-profile-card{grid-template-columns:1fr;min-height:auto;gap:18px;padding:26px 20px;text-align:center}.saju-day-mark{width:132px;height:132px}.saju-day-hanja{font-size:68px}.saju-day-label{font-size:13px}.saju-profile-copy h1{font-size:28px}.saju-meta{margin-top:12px;font-size:13px}.saju-profile-copy p{margin-top:18px;font-size:15px;text-align:left}.saju-hero-ora{width:150px;height:150px;margin-top:0;align-self:center}.saju-card{padding:24px 18px}.saju-section-head{display:block;text-align:center}.saju-section-head p{margin-top:8px}.saju-element-grid{grid-template-columns:1fr;gap:10px}.saju-element-card{min-height:142px}.saju-element-icon{min-height:34px;max-width:100%;font-size:24px}.saju-element-hanja{font-size:42px}.saju-element-name{font-size:15px}.saju-element-note{grid-template-columns:1fr;gap:8px;margin-top:20px;padding:18px}.saju-element-note img,.saju-element-note span{display:none}.saju-story-block{grid-template-columns:1fr;gap:12px;min-height:auto;padding:18px;text-align:left}.saju-story-block img{width:86px;height:86px;justify-self:center}.saju-summary-card{grid-template-columns:1fr;padding-bottom:24px}.saju-summary-card>img{display:none}.saju-keyword-band{margin:20px -18px 0;padding:20px 18px}.saju-keyword-band>div{grid-template-columns:1fr;gap:10px}.saju-keyword{min-height:48px;padding:10px;font-size:14px}.cute-keyword-card{padding:24px 18px}.saju-disclaimer{grid-template-columns:1fr;gap:10px;padding:18px;text-align:left}.saju-disclaimer-icon{font-size:32px}.saju-disclaimer img{display:none}.compat-hero-card{grid-template-columns:1fr;min-height:auto;padding:24px 18px;text-align:center}.compat-hero-left,.compat-hero-right,.compat-section-ora{display:none}.compat-day-pair{gap:10px;flex-wrap:wrap}.compat-hero-main h1{font-size:28px}.compat-profile-card{grid-template-columns:1fr;padding:18px}.compat-section-head{display:block;text-align:center}.compat-section-head p{margin-top:10px}.compat-section-body{grid-template-columns:1fr}.compat-cute-block{grid-template-columns:1fr}.compat-score-breakdown{grid-template-columns:1fr}}
...
@media (max-width:420px){.saju-element-card{min-height:128px}.saju-brand{font-size:28px}.saju-brand span{font-size:18px}.compat-day-pair{display:grid;grid-template-columns:1fr;justify-items:center}.compat-day-pair>span{font-size:26px}}
